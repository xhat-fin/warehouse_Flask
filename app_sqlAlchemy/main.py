...
def insert_goods():
    ...
    if good['name_goods'] is None or good['quantity'] is None or good['category_id'] is None or good['full_cost'] is None:
        return jsonify({"error": "info incorrect"}), HTTPStatus.BAD_REQUEST
    elif good['name_goods'] == '' or good['quantity'] == '' or good['category_id'] == '' or good[
        'full_cost'] == '':
        return jsonify({"error": "info incorrect"}), HTTPStatus.BAD_REQUEST

    db.insert_goods(good['name_goods'], good['quantity'], good['category_id'], good['full_cost'])
...
def insert_order_buy():
    ...
    if buy_info['goods_id'] is None or buy_info['supplier_id'] is None or buy_info['price'] is None or buy_info[
        'quantity'] is None or buy_info['date'] is None:

        return jsonify({"error": "info incorrect"}), HTTPStatus.BAD_REQUEST
    elif buy_info['goods_id'] == '' or buy_info['supplier_id'] == '' or buy_info['price'] == '' or buy_info[
        'quantity'] == '' or buy_info['date'] == '':

        return jsonify({"error": "info incorrect"}), HTTPStatus.BAD_REQUEST

    db.insert_order_buy(buy_info['goods_id'], buy_info['supplier_id'], buy_info['price'], buy_info[
...
def insert_order_sale():
    ...
    if sale_info['goods_id'] is None or sale_info['customer_id'] is None or sale_info['price'] is None or sale_info[
        'quantity'] is None or sale_info['date'] is None:

        return jsonify({"error": "info incorrect"}), HTTPStatus.BAD_REQUEST
    elif sale_info['goods_id'] == '' or sale_info['customer_id'] == '' or sale_info['price'] == '' or sale_info[
        'quantity'] == '' or sale_info['date'] == '':

        return jsonify({"error": "info incorrect"}), HTTPStatus.BAD_REQUEST

    db.insert_order_sale(sale_info['goods_id'], sale_info['customer_id'], sale_info['price'], sale_info[
